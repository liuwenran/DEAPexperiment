...
clear all;
ExSignal = '/net/liuwenran/datasets/DEAP/experiment/signalTrue1024/sig1024/';
ExHeartRate = '/net/liuwenran/datasets/DEAP/experiment/ex1_fc_gt/GTHR_norm_sigPeak1024_2/';
signalflist = dir(ExSignal);
HRflist = dir(ExHeartRate);
peopleNum = 22;
count = 0;
zeroCount = 0;
finalSignal = zeros(22*40*53,1024);
finalHR = zeros(22*40*53,1);
for i = 3:peopleNum+2
...
heartrate = finalHR(1:30000);
signal = finalSignal(1:30000,:);
save('finalExData/signal_train.mat','signal');
save('finalExData/HeartRate_train.mat','heartrate');
heartrate = finalHR(30001:end);
signal = finalSignal(30001:end,:);
